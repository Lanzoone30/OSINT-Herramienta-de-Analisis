...
# En esta clase manejo información geográfica de direcciones IP
# La idea aquí es usar una API pública gratuita para obtener datos de localización
class GeoService:
    ...
    def analyze(target, language="es"):
        ...
        try:
            ...
            try:
                ...
                # Timeout específico para evitar bloqueos largos
                if language == "es":
                    result += "\nERROR: Timeout de la API (10 segundos)\n"
                else:
                    result += "\nERROR: API timeout (10 seconds)\n"
