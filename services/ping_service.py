...
# En esta clase manejo pruebas de conectividad ICMP (ping)
# La idea aquí es usar el comando nativo del sistema para máxima compatibilidad
class PingService:
    
    @staticmethod
    def analyze(target, language="es"):
        # Ejecuto un ping al objetivo y analizo la conectividad
        try:
