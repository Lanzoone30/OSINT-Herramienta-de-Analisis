...
# En esta clase manejo análisis SSL/TLS de sitios web
# La idea aquí es verificar certificados y configuraciones de seguridad
class SSLService:
    ...
    def _get_security_checks(response, language):
        # Realizo verificaciones automáticas de seguridad
        checks = ""
        if language == "es":
