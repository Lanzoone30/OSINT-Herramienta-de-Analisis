...
# En esta clase manejo escaneo básico de puertos
# La idea aquí es proporcionar información útil sin requerir privilegios elevados
class PortService:
    
    @staticmethod
    def analyze(target, language="es"):
        # Realizo un escaneo de puertos comunes
        try:
            ...
            for port, service in common_ports:
                try:
                    ...
                    pass  # Ignoro errores para que el escaneo continúe
